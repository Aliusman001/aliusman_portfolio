  ...
  return (
    ...
    >
      <div className="max-w-[52rem] my-5 mx-auto gap-5 border border-border h-[86px] flex items-center rounded-[50px] px-3">
        ...
        />
        <button className="bg-primary flex-[0.3] hover:bg-orange-500 animation inline-block relative z-10 sm:px-8 px-4 py-4 sm:py-4 sm:text-xsmall text-base sm:leading-xsmall  font-normal text-white rounded-[60px]">
          Send
        </button>
      </div>
    </form>
