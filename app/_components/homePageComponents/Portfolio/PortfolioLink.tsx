...
function PortfolioLink({ href }: { href: string }) {
  return (
    <Link
      target="_blank"
      href={href}
      className="absolute z-50 group right-5 top-5 animation  rounded-full flex justify-center items-center group-hover:bg-primary sm:w-[64px] w-[34px] aspect-square sm:h-[64px] border border-primary"
    >
      <svg
        className="sm:w-6 w-4 aspect-square sm:h-6 group-hover:-rotate-45 animation  text-primary group-hover:text-white"
        width="26"
        height="22"
        viewBox="0 0 26 22"
        fill="none"
